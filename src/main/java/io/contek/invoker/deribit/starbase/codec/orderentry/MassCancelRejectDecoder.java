...
/** Hardcoded decoder for order-entry schema-v11 MassCancelReject (template 242). */
public final class MassCancelRejectDecoder {

  public static final int TEMPLATE_ID = 242;
  ...
  public static void validate(ByteBuffer buffer, int offset) {
    ...
    if (reason < 0 || reason > 3) {
      throw new StarbaseProtocolException("invalid MassCancelReject reason");
    }
  }
  ...
  private MassCancelRejectDecoder() {}
}
